...
const marks = [73, 55, 99];
const doubles = marks.map(elem => elem * 2); // এখানে extra করে elem-এর type দেয়া লাগবে না, কারণ TypeScript অনেক কিছু infer করতে পারে। TypeScript auto বুঝে যায় কারন marks একটা number-এর array।
